...
import com.snailscoder.core.tool.utils.ImageUtil;
 ...
 * @author snailscoder
 */
public class SnailFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{SnailFileUtil.formatUrl(uploadPath.toString()), SnailFileUtil.formatUrl(virtualPath.toString())};
	}
