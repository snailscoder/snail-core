...
public class SnailFileUtil {
	 ...
	 * @return SnailFile
	 */
	public static SnailFile getFile(MultipartFile file) {
	 ...
	 * @return SnailFile
	 */
	public static SnailFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return SnailFile
	 */
	public static SnailFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new SnailFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return SnailFile
	 */
	public static List<SnailFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return SnailFile
	 */
	public static List<SnailFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return SnailFile
	 */
	public static List<SnailFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<SnailFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new SnailFile(file, dir, path, virtualPath));
		}
		return list;
	}
