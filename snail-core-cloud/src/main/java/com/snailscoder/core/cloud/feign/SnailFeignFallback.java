...
@Slf4j
@AllArgsConstructor
public class SnailFeignFallback<T> implements MethodInterceptor {
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
		...
		log.error("SnailFeignFallback:[{}.{}] serviceId:[{}] message:[{}]", targetType.getName(), method.getName(), targetName, errorMessage);
	...
	public boolean equals(Object o) {
		...
		SnailFeignFallback<?> that = (SnailFeignFallback<?>) o;
