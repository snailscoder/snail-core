 ...
 */
@AllArgsConstructor
public class SnailHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	@Nullable
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		Callable<T> wrapCallable = new SnailHttpHeadersCallable<>(callable, accountGetter, properties);
		return existingConcurrencyStrategy != null
