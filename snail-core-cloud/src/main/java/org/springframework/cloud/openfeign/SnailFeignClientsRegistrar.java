...
import com.snailscoder.core.cloud.feign.SnailFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class SnailFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return SnailFeignAutoConfiguration.class;
	}
