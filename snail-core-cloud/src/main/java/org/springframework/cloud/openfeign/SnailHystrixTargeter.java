...
import com.snailscoder.core.cloud.feign.SnailFallbackFactory;
import org.springframework.lang.Nullable;

/**
 * 添加 snail 默认的 fallbackFactory L.cm 2019.01.19
 *
 * @author L.cm
 * @author Spencer Gibb
 * @author Erik Kringen
...
public class SnailHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		// snail 默认的 fallbackFactory
		SnailFallbackFactory snailFallbackFactory = new SnailFallbackFactory(target);
		return (T) builder.target(target, snailFallbackFactory);
	}
