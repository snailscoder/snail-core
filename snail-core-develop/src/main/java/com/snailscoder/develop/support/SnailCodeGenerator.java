 ...
 */
package com.snailscoder.develop.support;
...
import com.snailscoder.develop.constant.DevelopConstant;
import lombok.Data;
...
@Data
@Slf4j
public class SnailCodeGenerator {
	/**
	 * 代码所在系统
	 */
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "snail-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "com.snailscoder.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"snail_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"snail_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("com.snailscoder.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("com.snailscoder.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("com.snailscoder.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.snailscoder.core.boot.ctrl.SnailController");
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/snail-ops/snail-develop" : packageDir) + "/src/main/java";
	}
