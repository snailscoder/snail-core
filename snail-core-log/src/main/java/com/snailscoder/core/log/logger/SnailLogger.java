 ...
 */
package com.snailscoder.core.log.logger;

import com.snailscoder.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class SnailLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": SnailLogger init success!");
	}
