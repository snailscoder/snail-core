 ...
 */
package com.snailscoder.core.oss;
...
import com.snailscoder.core.oss.model.SnailFile;
import com.snailscoder.core.oss.model.OssFile;
import com.snailscoder.core.oss.props.OssProperties;
import com.snailscoder.core.oss.rule.OssRule;
...
public class AliossTemplate {
	...
	@SneakyThrows
	public SnailFile putFile(MultipartFile file) {
	...
	@SneakyThrows
	public SnailFile putFile(String fileName, MultipartFile file) {
		return putFile(ossProperties.getBucketName(), fileName, file);
	}

	@SneakyThrows
	public SnailFile putFile(String bucketName, String fileName, MultipartFile file) {
		return putFile(bucketName, fileName, file.getInputStream());
	}

	@SneakyThrows
	public SnailFile putFile(String fileName, InputStream stream) {
		return putFile(ossProperties.getBucketName(), fileName, stream);
	}

	@SneakyThrows
	public SnailFile putFile(String bucketName, String fileName, InputStream stream) {
		return put(bucketName, stream, fileName, false);
	}

	@SneakyThrows
	public SnailFile put(String bucketName, InputStream stream, String key, boolean cover) {
