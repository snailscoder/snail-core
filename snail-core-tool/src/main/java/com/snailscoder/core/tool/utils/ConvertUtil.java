...
package com.snailscoder.core.tool.utils;

import lombok.experimental.UtilityClass;
import com.snailscoder.core.tool.convert.SnailConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = SnailConversionService.getInstance();
